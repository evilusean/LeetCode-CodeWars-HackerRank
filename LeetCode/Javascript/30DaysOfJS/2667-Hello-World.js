...
(...)Rest Arguments
You can use rest syntax to access all the passed arguments as an array. This isn't necessary for this problem, 
but it will be a critical concept for many problems. You can read more about ... syntax here.
...
The primary use-case is for creating generic factory functions that accept any function as input and return a new version of the 
function with some specific modification.
By the way, a function that accepts a function and/or returns a function is called a higher-order function,
 and they are very common in JavaScript.
...
var createHelloWorld = function () {
  //You can assign a function to a variable name so 'createHelloWorld(parameters)' will run the function
  return function (...args) {
    return "Hello World";
  };
};
